...
foreach(period IN ITEMS 1 1205100 4294967297)
    ...
    foreach(group IN ITEMS 64 128 256)
        foreach(mode IN ITEMS legacy inline legacy-subgroup inline-subgroup)
            if(mode MATCHES "subgroup$")
                set(standard CL2.0)
            else()
                set(standard CL1.2)
            endif()
            ...
            execute_process(COMMAND "${CLANG}" -x cl "-cl-std=${standard}" -fgnu89-inline
    ...
    endforeach()
endforeach()
message(STATUS "Compiled 36 OpenCL kernels (legacy/inline mix, portable/subgroup broadcasts); GPU execution was not tested")
