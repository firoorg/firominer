...
static inline uint64_t rotl_64(uint64_t x, unsigned s)
{
    return (x << s) | (x >> (-s & 63));
}
...
static inline ALWAYS_INLINE void keccakf1600_implementation(uint64_t state[25])
{
    ...
    for (size_t n = 0; n < 24; n += 2)
    {
        ...
        Ba = Aba ^ Da;
        Be = rotl_64(Age ^ De, 44);
        Bi = rotl_64(Aki ^ Di, 43);
        Bo = rotl_64(Amo ^ Do, 21);
        Bu = rotl_64(Asu ^ Du, 14);
        ...
        Ba = rotl_64(Abo ^ Do, 28);
        Be = rotl_64(Agu ^ Du, 20);
        Bi = rotl_64(Aka ^ Da, 3);
        Bo = rotl_64(Ame ^ De, 45);
        Bu = rotl_64(Asi ^ Di, 61);
        Ega = Ba ^ (~Be & Bi);
        Ege = Be ^ (~Bi & Bo);
        Egi = Bi ^ (~Bo & Bu);
        Ego = Bo ^ (~Bu & Ba);
        ...
        Ba = rotl_64(Abe ^ De, 1);
        Be = rotl_64(Agi ^ Di, 6);
        Bi = rotl_64(Ako ^ Do, 25);
        Bo = rotl_64(Amu ^ Du, 8);
        Bu = rotl_64(Asa ^ Da, 18);
        Eka = Ba ^ (~Be & Bi);
        Eke = Be ^ (~Bi & Bo);
        Eki = Bi ^ (~Bo & Bu);
        Eko = Bo ^ (~Bu & Ba);
        ...
        Ba = rotl_64(Abu ^ Du, 27);
        Be = rotl_64(Aga ^ Da, 36);
        Bi = rotl_64(Ake ^ De, 10);
        Bo = rotl_64(Ami ^ Di, 15);
        Bu = rotl_64(Aso ^ Do, 56);
        Ema = Ba ^ (~Be & Bi);
        Eme = Be ^ (~Bi & Bo);
        Emi = Bi ^ (~Bo & Bu);
        Emo = Bo ^ (~Bu & Ba);
        ...
        Ba = rotl_64(Abi ^ Di, 62);
        Be = rotl_64(Ago ^ Do, 55);
        Bi = rotl_64(Aku ^ Du, 39);
        Bo = rotl_64(Ama ^ Da, 41);
        Bu = rotl_64(Ase ^ De, 2);
        Esa = Ba ^ (~Be & Bi);
        Ese = Be ^ (~Bi & Bo);
        Esi = Bi ^ (~Bo & Bu);
        ...
        Ba = Eba ^ Da;
        Be = rotl_64(Ege ^ De, 44);
        Bi = rotl_64(Eki ^ Di, 43);
        Bo = rotl_64(Emo ^ Do, 21);
        Bu = rotl_64(Esu ^ Du, 14);
        ...
        Ba = rotl_64(Ebo ^ Do, 28);
        Be = rotl_64(Egu ^ Du, 20);
        Bi = rotl_64(Eka ^ Da, 3);
        Bo = rotl_64(Eme ^ De, 45);
        Bu = rotl_64(Esi ^ Di, 61);
        Aga = Ba ^ (~Be & Bi);
        Age = Be ^ (~Bi & Bo);
        Agi = Bi ^ (~Bo & Bu);
        Ago = Bo ^ (~Bu & Ba);
        ...
        Ba = rotl_64(Ebe ^ De, 1);
        Be = rotl_64(Egi ^ Di, 6);
        Bi = rotl_64(Eko ^ Do, 25);
        Bo = rotl_64(Emu ^ Du, 8);
        Bu = rotl_64(Esa ^ Da, 18);
        Aka = Ba ^ (~Be & Bi);
        Ake = Be ^ (~Bi & Bo);
        Aki = Bi ^ (~Bo & Bu);
        Ako = Bo ^ (~Bu & Ba);
        ...
        Ba = rotl_64(Ebu ^ Du, 27);
        Be = rotl_64(Ega ^ Da, 36);
        Bi = rotl_64(Eke ^ De, 10);
        Bo = rotl_64(Emi ^ Di, 15);
        Bu = rotl_64(Eso ^ Do, 56);
        Ama = Ba ^ (~Be & Bi);
        Ame = Be ^ (~Bi & Bo);
        Ami = Bi ^ (~Bo & Bu);
        Amo = Bo ^ (~Bu & Ba);
        ...
        Ba = rotl_64(Ebi ^ Di, 62);
        Be = rotl_64(Ego ^ Do, 55);
        Bi = rotl_64(Eku ^ Du, 39);
        Bo = rotl_64(Ema ^ Da, 41);
        Bu = rotl_64(Ese ^ De, 2);
        Asa = Ba ^ (~Be & Bi);
        Ase = Be ^ (~Bi & Bo);
        Asi = Bi ^ (~Bo & Bu);
